package com.javaniuniu.log.aspect;
...
public class UserAccessAspect {
    ...
    @Pointcut("execution(public * com.javaniuniu.log.controller.*.*(..))")
    public void webLog() {
    }
...
//        log.info(sourceLocation.getWithinType().toString());
     ...
     */
    @Around("execution(public * com.javaniuniu.log.controller.*.*(..)) && @annotation(com.javaniuniu.log.aspect.UserAccess)")
