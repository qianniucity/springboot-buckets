...
public class UserAccessAspect {
    ...
    @Pointcut("execution(public * com.javaniuniu.exception.controller.*.*(..))")
    public void webLog() {
    }
...
//        log.info(sourceLocation.getWithinType().toString());
     ...
     */
    @Around("execution(public * com.javaniuniu.exception.controller.*.*(..)) && @annotation(com.javaniuniu.exception.aspect.UserAccess)")
